...
#Introduction  
Today, we chose to label a world map showing the locations of the meteorite landings.
...
```{r 2021_03_08_lab_assignment, fig.width = 8, fig.height = 5, fig.cap = "Figure 1. Locations of meteorite landings throughout the world.", fig.align= "center"}
ggplot() + 
...
![Mood when coding](https://media4.giphy.com/media/fQZX2aoRC1Tqw/giphy.gif)
