...
Reasons why it's a *bad plot* are:  
  - The Y-axis is unreadable.  
  - The X-axis is discrete and doesn't share a lot of information.  
  - The title is just on the right side of the plot for no reason.  
  - Although I like the color blue, this is just a bad color scheme.  
  - The data isn't wrangled well enough for it be a meaningful plot.   
...
Reasons its a *good plot* are:    
  - The data is cleaned up and wrangled to be meaningful.   
  - The data is narrowed down to show the Top 10 best episodes from the   Office.  
  - The plot is pleasing to the eye and doesn't distract the reader.  
  - The X and Y axes are useful and understandable.   
  - The title and names tells the story of the plot.   
